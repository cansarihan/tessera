...
const base =
  'w-full rounded-xl border border-white/10 bg-ink-900/60 px-3.5 py-2.5 text-sm text-fg placeholder:text-fg-subtle outline-none transition focus:border-holo-violet/50 focus:ring-2 focus:ring-holo-violet/20';
